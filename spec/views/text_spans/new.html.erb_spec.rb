...
describe "text_spans/new.html.erb" do
  before(:each) do
    assign(:text_span, stub_model(TextSpan,
      :start => 1,
      :length => 1,
      :session => "MyString",
      :tag => nil,
  ...
  it "renders new text_span form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => text_spans_path, :method => "post" do
